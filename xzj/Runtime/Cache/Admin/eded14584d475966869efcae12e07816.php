<?php if (!defined('THINK_PATH')) exit();?><div class="pageContent">
	<form method="post" action="/blog1/index.php/Admin/Guest/add/navTabId/用户列表/callbackType/closeCurrent" enctype="multipart/form-data"  class="pageForm required-validate" 
		...
		<div class="pageFormContent" layoutH="60">
			...
			<dl>
				...
				<option value="1"  >男</option><option value="1"  >女</option>
				</select></dd>
			</dl>			
			<dl>
				<dt>E-Mail：</dt>
				<dd><input type="text"  style="width:100%" name="email" /></dd>
			</dl>
			...
			<dl>
				...
				<dd>
<input class="date  readonly " type="text" readonly="true" name="date1" ">
